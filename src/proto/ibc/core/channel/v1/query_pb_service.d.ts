...
type QueryUnrelayedAcks = {
  readonly methodName: string;
  readonly service: typeof Query;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof ibc_core_channel_v1_query_pb.QueryUnrelayedAcksRequest;
  readonly responseType: typeof ibc_core_channel_v1_query_pb.QueryUnrelayedAcksResponse;
};
...
export class Query {
  ...
  static readonly UnrelayedAcks: QueryUnrelayedAcks;
...
export class QueryClient {
  ...
  unrelayedAcks(
    requestMessage: ibc_core_channel_v1_query_pb.QueryUnrelayedAcksRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: ibc_core_channel_v1_query_pb.QueryUnrelayedAcksResponse|null) => void
  ): UnaryResponse;
  unrelayedAcks(
    requestMessage: ibc_core_channel_v1_query_pb.QueryUnrelayedAcksRequest,
    callback: (error: ServiceError|null, responseMessage: ibc_core_channel_v1_query_pb.QueryUnrelayedAcksResponse|null) => void
