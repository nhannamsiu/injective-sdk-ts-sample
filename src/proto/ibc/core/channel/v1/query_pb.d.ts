...
export class QueryChannelResponse extends jspb.Message {
  ...
  getProofPath(): string;
  setProofPath(value: string): void;
...
export class QueryPacketCommitmentsResponse extends jspb.Message {
  ...
  getCommitmentsList(): Array<ibc_core_channel_v1_channel_pb.PacketAckCommitment>;
  setCommitmentsList(value: Array<ibc_core_channel_v1_channel_pb.PacketAckCommitment>): void;
  addCommitments(value?: ibc_core_channel_v1_channel_pb.PacketAckCommitment, index?: number): ibc_core_channel_v1_channel_pb.PacketAckCommitment;
...
export namespace QueryPacketCommitmentsResponse {
  export type AsObject = {
    commitmentsList: Array<ibc_core_channel_v1_channel_pb.PacketAckCommitment.AsObject>,
    pagination?: cosmos_base_query_v1beta1_pagination_pb.PageResponse.AsObject,
    height?: ibc_core_client_v1_client_pb.Height.AsObject,
  }
}
...
export class QueryUnrelayedAcksRequest extends jspb.Message {
  getPortId(): string;
  setPortId(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): QueryUnrelayedAcksRequest.AsObject;
  static toObject(includeInstance: boolean, msg: QueryUnrelayedAcksRequest): QueryUnrelayedAcksRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: QueryUnrelayedAcksRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): QueryUnrelayedAcksRequest;
  static deserializeBinaryFromReader(message: QueryUnrelayedAcksRequest, reader: jspb.BinaryReader): QueryUnrelayedAcksRequest;
}

export namespace QueryUnrelayedAcksRequest {
  export type AsObject = {
    portId: string,
    channelId: string,
    packetCommitmentSequencesList: Array<number>,
...
export class QueryUnrelayedAcksResponse extends jspb.Message {
  clearSequencesList(): void;
  getSequencesList(): Array<number>;
  setSequencesList(value: Array<number>): void;
  addSequences(value: number, index?: number): number;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): QueryUnrelayedAcksResponse.AsObject;
  static toObject(includeInstance: boolean, msg: QueryUnrelayedAcksResponse): QueryUnrelayedAcksResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: QueryUnrelayedAcksResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): QueryUnrelayedAcksResponse;
  static deserializeBinaryFromReader(message: QueryUnrelayedAcksResponse, reader: jspb.BinaryReader): QueryUnrelayedAcksResponse;
}

export namespace QueryUnrelayedAcksResponse {
  export type AsObject = {
    sequencesList: Array<number>,
    height?: ibc_core_client_v1_client_pb.Height.AsObject,
  }
