...
Query.UnrelayedAcks = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: ibc_core_channel_v1_query_pb.QueryUnrelayedAcksRequest,
  responseType: ibc_core_channel_v1_query_pb.QueryUnrelayedAcksResponse
};
...
QueryClient.prototype.unrelayedAcks = function unrelayedAcks(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Query.UnrelayedAcks, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
