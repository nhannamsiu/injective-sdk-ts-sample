...
export class GenesisState extends jspb.Message {
  ...
  getAcknowledgementsList(): Array<ibc_core_channel_v1_channel_pb.PacketAckCommitment>;
  setAcknowledgementsList(value: Array<ibc_core_channel_v1_channel_pb.PacketAckCommitment>): void;
  addAcknowledgements(value?: ibc_core_channel_v1_channel_pb.PacketAckCommitment, index?: number): ibc_core_channel_v1_channel_pb.PacketAckCommitment;
...
export namespace GenesisState {
  export type AsObject = {
    ...
    acknowledgementsList: Array<ibc_core_channel_v1_channel_pb.PacketAckCommitment.AsObject>,
