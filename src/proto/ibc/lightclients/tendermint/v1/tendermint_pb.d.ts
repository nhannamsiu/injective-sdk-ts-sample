...
export class ClientState extends jspb.Message {
  ...
  getConsensusParams(): tendermint_abci_types_pb.ConsensusParams | undefined;
  setConsensusParams(value?: tendermint_abci_types_pb.ConsensusParams): void;
  ...
  setUpgradePath(value: string): void;
...
export namespace ClientState {
  export type AsObject = {
    ...
    consensusParams?: tendermint_abci_types_pb.ConsensusParams.AsObject,
